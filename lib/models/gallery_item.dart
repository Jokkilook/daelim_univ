...
class GalleryItem {
  ...
  @override
  String toString() =>
      'GalleryItem(total: $total, totalHits: $totalHits, hits: $hits)';
...
class GalleryItemHits {
  ...
  @override
  String toString() {
    return 'GalleryItemHits(id: $id, tags: $tags, webformatURL: $webformatURL, largeImageURL: $largeImageURL, imageWidth: $imageWidth, imageHeight: $imageHeight, imageSize: $imageSize, views: $views, collections: $collections, downloads: $downloads, comments: $comments, likes: $likes, user_id: $userId, user: $user, userImageURL: $userImageURL)';
  }
